...
public interface DIDResolverService {
     ...
     */
    DIDDocument resolve(String did) throws DIDServerException;
     ...
     * @throws DIDServerException If resolution fails
     */
    DIDDocument resolve(String did, boolean useCache) throws DIDServerException;
     ...
     * @throws DIDServerException If resolution fails or key not found
     */
    PublicKey getPublicKey(String did, String keyId) throws DIDServerException;
     ...
     * @throws DIDServerException If resolution fails or key not found
     */
    PublicKey getPublicKeyFromReference(String verificationMethodRef) throws DIDServerException;
