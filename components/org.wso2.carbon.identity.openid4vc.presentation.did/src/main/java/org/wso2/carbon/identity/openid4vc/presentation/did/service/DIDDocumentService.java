...
public interface DIDDocumentService {
     ...
     * @throws DIDServerException if document generation fails
     */
    String getDIDDocument(String domain, int tenantId) throws DIDServerException;
     ...
     * @throws DIDServerException if document generation fails
     */
    DIDDocument getDIDDocumentObject(String domain, int tenantId) throws DIDServerException;
