...
public interface DIDProvider {
    ...
    /**
     * Get the DID identifier for the given tenant and domain.
     * 
     ...
     */
    String getDID(int tenantId, String domain) throws VPException;
    ...
    /**
     * Get the DID document for the given tenant and domain.
     * 
     * @param tenantId The tenant ID
     * @param domain The domain name
     ...
     */
    DIDDocument getDIDDocument(int tenantId, String domain) throws VPException;
