...
import org.wso2.carbon.identity.openid4vc.oid4vp.common.util.SecurityUtils;
...
public class OpenID4VPAuthenticatorTest {
    ...
    public void testProcessAuthenticationResponseWithExpiredRequest() throws Exception {
        ...
        when(vpRequestService.getVPRequestById(anyString(), anyInt()))
                .thenThrow(new org.wso2.carbon.identity.openid4vc.oid4vp.common.exception.VPRequestExpiredException(
                        "Error", 1600000000000L));
