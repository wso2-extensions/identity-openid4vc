...
public class Constraints {
    ...
    public static final String PARAM_ROOT_TENANT_DOMAIN = "rootTenantDomain";

    public static final String CONTEXT_EFFECTIVE_TENANT_DOMAIN = "vpEffectiveTenantDomain";
    ...
    public static final String CLIENT_ID_SCHEME_REDIRECT_URI = "redirect_uri";
    ...
    public static final int DISPLAY_ORDER_6 = 6;
    public static final int DISPLAY_ORDER_7 = 7;
