...
public class VPAuthenticatorException extends Exception {
    ...
    public VPAuthenticatorException(final VPAuthenticatorErrorCode errorCodeParam, final String message) {
        super(message);
    ...
    public VPAuthenticatorException(final VPAuthenticatorErrorCode errorCodeParam, final String message,
                                    final String descriptionParam, final Throwable cause) {
        super(message, cause);
        this.errorCode = errorCodeParam;
        this.description = descriptionParam;
    }

    public VPAuthenticatorErrorCode getErrorCode() { return errorCode; }

    public String getCode() { return errorCode != null ? errorCode.getCode() : null; }

    public String getOAuth2ErrorCode() { return errorCode != null ? errorCode.getOAuth2ErrorCode() : null; }
