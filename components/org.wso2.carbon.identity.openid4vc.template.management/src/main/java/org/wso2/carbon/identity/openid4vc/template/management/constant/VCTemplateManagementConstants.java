...
import static org.wso2.carbon.identity.openid4vc.template.management.constant.SQLConstants.CURSOR_KEY_COLUMN_NAME;
import static org.wso2.carbon.identity.openid4vc.template.management.constant.SQLConstants.DISPLAY_NAME_COLUMN_NAME;
import static org.wso2.carbon.identity.openid4vc.template.management.constant.SQLConstants.FORMAT_COLUMN_NAME;
import static org.wso2.carbon.identity.openid4vc.template.management.constant.SQLConstants.IDENTIFIER_COLUMN_NAME;

/**
 * Constants for VC Config Management.
 */
public class VCTemplateManagementConstants {
     ...
     */
    public static final java.util.Set<String> SUPPORTED_FORMATS = java.util.Collections.unmodifiableSet(
            new java.util.HashSet<String>() {
                {
                    add(DEFAULT_VC_FORMAT);
