...
public class VCTemplateMgtDAOTest {
    ...
    /**
     * Test retrieving VC templates for different tenant scenarios.
     *
    ...
    public void testGetVCCredentialConfigurations(int tenantId, int expectedCount)
        ...
        List<VCTemplate> configurations = vcConfigMgtDAOImpl.list(tenantId);
        ...
        if (expectedCount > 0) {
            for (VCTemplate config : configurations) {
    ...
    /**
     * Test retrieving a specific VC template by identifier.
     *
     * @param tenantId Tenant ID to test.
    ...
    public void testGetVCCredentialConfigurationByIdentifier(int tenantId, String identifier, boolean shouldExist)
        ...
        VCTemplate config = vcConfigMgtDAOImpl.getByIdentifier(identifier, tenantId);
    ...
    public void testTenantIsolation(int ownerTenantId, int attackerTenantId)
        ...
        VCTemplate createdConfig = vcConfigMgtDAOImpl.getByIdentifier(uniqueIdentifier, ownerTenantId);
        ...
        VCTemplate attackerAccessedConfig = vcConfigMgtDAOImpl.get(configUuid, attackerTenantId);
        ...
        VCTemplate ownerAccessedConfig = vcConfigMgtDAOImpl.get(configUuid, ownerTenantId);
    ...
    public void testAddVCCredentialConfiguration(String postfix, int tenantId, boolean shouldSucceed)
        ...
        VCTemplate createdConfig  = vcConfigMgtDAOImpl.add(config, tenantId);
    ...
    /**
     * Test checking if VC templates exist by identifier.
     *
     * @param tenantId Tenant ID to test.
     * @param identifier Configuration identifier.
     * @param shouldExist Whether the configuration should exist.
    ...
    /**
     * Add VC template to the database.
     *
    ...
    private static VCTemplate createVCCredentialConfiguration(String identifier, String format,
        ...
        vcTemplate.setDisplayName(identifier);
        vcTemplate.setDescription("Test description for " + identifier);
        vcTemplate.setFormat(format);
        vcTemplate.setSigningAlgorithm("RS256");
