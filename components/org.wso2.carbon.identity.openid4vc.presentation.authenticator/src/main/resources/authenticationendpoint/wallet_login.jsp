...
<%
    ...
    String clientIdScheme = request.getParameter("clientIdScheme");
    ...
    <body class="login-portal layout totp-portal-layout">
        ...
        <script type="text/javascript">
            ...
            var CONFIG = {
                ...
                clientIdScheme: '<%=clientIdScheme != null ? Encode.forJavaScript(clientIdScheme) : ""%>',
            ...
            function buildRequestUriQRContent(requestUri, clientId, clientIdScheme) {
                if (!requestUri) {
                    return '';
                }
                ...
                if (clientIdScheme && clientIdScheme !== 'redirect_uri') {
                    content += 'client_id_scheme=' + encodeURIComponent(clientIdScheme) + '&';
                }
            ...
            document.addEventListener('DOMContentLoaded', function() {
                CONFIG.qrContent = buildRequestUriQRContent(CONFIG.requestUri, CONFIG.clientId, CONFIG.clientIdScheme);
