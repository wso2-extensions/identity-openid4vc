...
public class VPAuthenticatorClientException extends VPAuthenticatorException {
    ...
    public VPAuthenticatorClientException(String message, Throwable cause) {

        super(message, cause);
    }

    public VPAuthenticatorClientException(VPAuthenticatorErrorCode errorCode, String message) {
