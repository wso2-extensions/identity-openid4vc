...
/**
 * In-memory {@link ServletInputStream} for servlet unit tests.
 */
class InMemoryServletInputStream extends ServletInputStream {

    private final ByteArrayInputStream bais;

    InMemoryServletInputStream(byte[] data) {
