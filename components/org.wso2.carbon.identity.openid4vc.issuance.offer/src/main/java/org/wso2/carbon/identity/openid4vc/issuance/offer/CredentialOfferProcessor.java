...
/**
 * Processor for handling OID4VCI credential offer operations.
 */
public interface CredentialOfferProcessor {
     ...
     */
    CredentialOfferResponse generateOffer(String offerId, String tenantDomain)
